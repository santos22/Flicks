...
- [X] Customize the selection effect of the cell (fades in while scrolling).
...
- [X] Users can view trailers for each film in full screen.

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Understanding and configuring the app delegate file.
2. Possibly extending your app with a server (Flask, node.js, etc.) and how that works.
